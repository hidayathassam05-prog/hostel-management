        ...
        <div class="container">
            <section class="text-center" style="padding: 3rem 0;">
                ...
                <div style="margin-top: 2rem;">
                    <a href="login.php" class="btn" style="display: inline-block; margin-right: 1rem; background-color: #0066cc; color: white; padding: 0.75rem 2rem; border-radius: 4px;">Login</a>
                    <a href="register.php" class="btn" style="display: inline-block; background-color: #28a745; color: white; padding: 0.75rem 2rem; border-radius: 4px;">Create Account</a>
                </div>
            </section>
